...
//    printf("---------------------------------------\n");
    ...
    mu_assert("test_is_there_not_edge_between_nodes 10 - 20 fail", graph_is_there_an_edge(graph, 10, 20) == 0);
    mu_assert("test_is_there_not_edge_between_nodes 20 - 10 fail", graph_is_there_an_edge(graph, 20, 10) == 0);
    return 0;
}
...
//    printf("---------------------------------------\n");
    ...
    mu_assert("test_create_edge_many_nodes 10 - 20 fail", graph_is_there_an_edge(graph, 10, 20) == 1);
    mu_assert("test_create_edge_many_nodes 20 - 10 fail", graph_is_there_an_edge(graph, 20, 10) == 1);
    mu_assert("test_create_edge_many_nodes 70 - 80 fail", graph_is_there_an_edge(graph, 70, 80) == 1);
    mu_assert("test_create_edge_many_nodes 80 - 70 fail", graph_is_there_an_edge(graph, 80, 70) == 1);
    mu_assert("test_create_edge_many_nodes 80 - 10 fail", graph_is_there_an_edge(graph, 80, 10) == 1);
    mu_assert("test_create_edge_many_nodes 10 - 80 fail", graph_is_there_an_edge(graph, 10, 80) == 1);
    mu_assert("test_create_edge_many_nodes 60 !- 80 fail", graph_is_there_an_edge(graph, 60, 80) == 0);
    mu_assert("test_create_edge_many_nodes 80 !- 60 fail", graph_is_there_an_edge(graph, 80, 60) == 0);
    mu_assert("test_create_edge_many_nodes 10 - 70 fail", graph_is_there_an_edge(graph, 10, 70) == 1);
    mu_assert("test_create_edge_many_nodes 70 - 10 fail", graph_is_there_an_edge(graph, 70, 10) == 1);
    return 0;
}
...
//    printf("---------------------------------------\n");
    ...
    mu_assert("test_test_create_edge 10 - 20 fail", graph_is_there_an_edge(graph, 10, 20) == 1);
    mu_assert("test_test_create_edge 20 - 10 fail", graph_is_there_an_edge(graph, 20, 10) == 1);
    return 0;
}
